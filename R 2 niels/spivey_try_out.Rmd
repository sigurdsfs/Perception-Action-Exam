...
spivey_try_out <- read.csv(file="spivey_try_out.csv", header=TRUE, sep=",")
colnames(spivey_try_out)
spivey_norm_derv_data <- read.csv(file="spivey_norm_derv_data.csv", header=TRUE, sep=",")
colnames(spivey_norm_derv_data)
